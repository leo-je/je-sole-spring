...
public class TaskHistory implements Serializable {
     ...
     * <pre>
     * 任务id
     * 表字段 : t_tasks_task_history.task_id
     * </pre>
     */
     ...
     * <pre>
     * 程序队列
     * 表字段 : t_tasks_task_history.process_list
     * </pre>
     */
     ...
     * <pre>
     * 状态
     * 表字段 : t_tasks_task_history.status
     * </pre>
     */
     ...
     * <pre>
     * 参数
     * 表字段 : t_tasks_task_history.param
     * </pre>
     */
     ...
     * <pre>
     * 当前任务标号
     * 表字段 : t_tasks_task_history.current_task_order
     * </pre>
     */
     ...
     * <pre>
     * 任务结束时间
     * 表字段 : t_tasks_task_history.end_time
     * </pre>
     */
     ...
     * <pre>
     * 任务开始时间
     * 表字段 : t_tasks_task_history.start_time
     * </pre>
     */
     ...
     * <pre>
     * 创建时间
     * 表字段 : t_tasks_task_history.create_time
     * </pre>
     */
     ...
     * <pre>
     * 更新时间
     * 表字段 : t_tasks_task_history.update_time
     * </pre>
     */
     ...
     * <pre>
     * 运行版本
     * 表字段 : t_tasks_task_history.run_version
     * </pre>
     */
     ...
     * </pre>
     *
     * @return t_tasks_task_history.id：主键
     */
    public String getId() {
        return id;
    }
     ...
     * </pre>
     *
     * @return t_tasks_task_history.task_id：任务id
     */
     ...
     *
     * @param taskId
     *            t_tasks_task_history.task_id：任务id
     */
     ...
     * </pre>
     *
     * @return t_tasks_task_history.name：任务名称
     */
     ...
     *
     * @param name
     *            t_tasks_task_history.name：任务名称
     */
     ...
     * </pre>
     *
     * @return t_tasks_task_history.process_list：程序队列
     */
     ...
     *
     * @param processList
     *            t_tasks_task_history.process_list：程序队列
     */
     ...
     * </pre>
     *
     * @return t_tasks_task_history.type：类型：1-即时任务 2-周期任务 3-定时任务
     */
     ...
     *
     * @param type
     *            t_tasks_task_history.type：类型：1-即时任务 2-周期任务 3-定时任务
     */
     ...
     * </pre>
     *
     * @return t_tasks_task_history.status：状态
     */
     ...
     *
     * @param status
     *            t_tasks_task_history.status：状态
     */
     ...
     * </pre>
     *
     * @return t_tasks_task_history.param：参数
     */
     ...
     * </pre>
     *
     * @return t_tasks_task_history.info：简介
     */
     ...
     * </pre>
     *
     * @return t_tasks_task_history.current_task_order：当前任务标号
     */
     ...
     *            t_tasks_task_history.current_task_order：当前任务标号
     */
     ...
     * </pre>
     *
     * @return t_tasks_task_history.end_time：任务结束时间
     */
     ...
     *
     * @param endTime
     *            t_tasks_task_history.end_time：任务结束时间
     */
     ...
     * </pre>
     *
     * @return t_tasks_task_history.start_time：任务开始时间
     */
     ...
     *
     * @param startTime
     *            t_tasks_task_history.start_time：任务开始时间
     */
     ...
     * </pre>
     *
     * @return t_tasks_task_history.create_time：创建时间
     */
     ...
     *
     * @param createTime
     *            t_tasks_task_history.create_time：创建时间
     */
     ...
     * </pre>
     *
     * @return t_tasks_task_history.update_time：更新时间
     */
     ...
     *
     * @param updateTime
     *            t_tasks_task_history.update_time：更新时间
     */
     ...
     * </pre>
     *
     * @return t_tasks_task_history.run_version：运行版本
     */
     ...
     *
     * @param runVersion
     *            t_tasks_task_history.run_version：运行版本
     */
    ...
    public boolean equals(Object that) {
        ...
        TaskHistory other = (TaskHistory) that;
